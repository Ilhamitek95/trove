...
- Tests: `cd backend && npm test` (node:test suite, ~143 tests) — run before any push. Unset `ANTHROPIC_API_KEY` first (the user env var leaks in and breaks tags.test.js).
