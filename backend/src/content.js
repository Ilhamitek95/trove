...
const DEFAULTS = {
  ...
  'home.marquee': {
    items: [
      ...
      { head: '30-day returns', sub: 'Free on every order' },
    ],
  },
  ...
  'sell.faq': {
    ...
    items: [
      ...
      { q: 'How and when do I get paid?', a: "Weekly, to the bank account you add in your dashboard. A sale becomes payable once the piece is delivered and the buyer's return window closes — your Payments page shows exactly what's coming and when." },
